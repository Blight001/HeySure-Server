...
def test_knowledge_search_lexical_fallback_ranks_relevant_entry_first(monkeypatch):
    ...
    # KnowledgeEntry table removed. _knowledge_search_result is a legacy stub.
    # Real knowledge retrieval now uses:
    #   - kb_store.keyword_search_knowledge (pure file)
    #   - knowledge_vector.semantic_search_knowledge (file + embeddings/*.json)
    ...
    # The stub safely returns empty; real paths are covered elsewhere.
